#!/usr/bin/env python3
"""Paper Figure 2: AUC by run for TASK vs fixation-based recentering."""
...
def main() -> None:
    default_input = REPO_ROOT / "data" / "processed" / "fig2_auc_subject_run.csv"
    ...
    parser.add_argument(
        "--summary-csv",
        type=Path,
        default=REPO_ROOT / "data" / "processed" / "fig2_run_level_summary.csv",
    ...
    if args.source == "paper":
        ...
        if not args.input_csv.exists():
            legacy = REPO_ROOT / "data" / "processed" / "fig6_auc_subject_run.csv"
    ...
    make_figure(
        summary,
        pvals=pvals,
        out_png=args.outdir / "fig2_auc_by_run_task_vs_fix.png",
        out_pdf=args.outdir / "fig2_auc_by_run_task_vs_fix.pdf",
