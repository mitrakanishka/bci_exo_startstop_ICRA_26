function [W,C,ManifoldMappingMutot,Stotal,mutot,mu] = fgda_satyam(Ctrain,Ytrain,METHOD_MEAN,ARG_MEAN,METHOD_COV,ARG_COV)
...
Stotal=sum(Covclass,3)/size(Covclass,3);
S=Stotal-Sb;
% S = mean(Covclass,3);
